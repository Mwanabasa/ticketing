...
<body style="font-family: sans-serif; color: #1e293b; background: #f8fafc; padding: 32px;">
    <div style="max-width: 560px; margin: 0 auto; background: #fff; border-radius: 12px; border: 1px solid #e2e8f0; padding: 32px;">
        ...
        <h1 style="font-size: 20px; font-weight: 700; margin: 0 0 16px;">Ticket assigned to you</h1>
        <p style="color: #475569; margin: 0 0 24px;">A support ticket has been assigned to you.</p>

        <div style="background: #f1f5f9; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
            <p style="margin: 0 0 6px;"><strong>Ticket #{{ $ticket->id }}</strong></p>
            <p style="margin: 0 0 6px; color: #475569;">{{ $ticket->subject }}</p>
